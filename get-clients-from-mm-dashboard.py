#!/usr/bin/python3
#
#	read client table from MM Dashboard
#
...
<aruba_queries><query>
	...
	<type>list</type>
	<list_query>
		<device_type>sta</device_type>
		<requested_columns>{columns}</requested_columns>
	</list_query>
	<filter>
		<global_operator>and</global_operator>
		<filter_list>
			<filter_item_entry>
				<field_name>client_conn_type</field_name>
				<comp_operator>not_equals</comp_operator>
				<value><![CDATA[0]]></value>
			</filter_item_entry>
		</filter_list>
	</filter>
